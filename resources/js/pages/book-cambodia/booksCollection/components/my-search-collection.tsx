...
const MySearchCollection = () => {
    ...
    return (
        <>
            <div className={`mx-auto max-w-screen-2xl px-3 pt-4 sm:px-10 lg:px-20 text-base text-black sm:text-xl lg:text-2xl ${fontClass}`}>{t('Books Management System')}</div>
            <div ref={sentinelRef} />
            <div
                ref={headerRef}
...
export default MySearchCollection;
