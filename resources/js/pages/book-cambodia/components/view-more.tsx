      ...
      <div className="btn-container">
        <a className="btn-content" href="#">
          ...
          <span className="icon-arrow">
            <svg width="28px" height="28px" viewBox="0 0 66 43" xmlns="http://www.w3.org/2000/svg">
...
const StyledWrapper = styled.div`
  ...
  display: flex;
    ...
    --color-text: #fff;
    --color-background: linear-gradient(135deg, #d69547, #f5c97a);
    --color-shadow: rgba(214, 149, 71, 0.5);
  }
